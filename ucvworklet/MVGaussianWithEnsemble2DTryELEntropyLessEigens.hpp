#ifndef UCV_MULTIVARIANT_GAUSSIAN2D_EL_LESS_EIGENS_h
#define UCV_MULTIVARIANT_GAUSSIAN2D_EL_LESS_EIGENS_h
...
class MVGaussianWithEnsemble2DTryELEntropyLessEigens : public vtkm::worklet::WorkletVisitCellsWithPoints
{
public:
    MVGaussianWithEnsemble2DTryELEntropyLessEigens(double isovalue, int num_sample)
