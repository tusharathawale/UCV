...
public:
    ...
    {
        printf("---debug SuperOptimizedCase indexOfa1 %d w1 %f \n", indexOfa1, w1);
        printf("---debug x1Limits\n");
        for (int i = 0; i < 6; i++)
        {
            printf("%f ", x1Limits[i]);
        }
        ...
        printf("----debug minProb first case %f\n", minProb);
    ...
    {
        printf("---debug ComputeIntegral input %f %f %f %f %f %f %f %f %f %f %f\n", l, h, h2, h3, h4, h5, n1, n2, n3, n4, n5);
