...
int main(int argc, char *argv[])
{
    ...
    std::string meanWaterFractionFile = dataFolder + "/WaterFraction.vtk";
    //std::string devWaterFraction = dataFolder + "/devWaterFraction.vtk";

    std::string meanTemp = dataFolder + "/temp.vtk";
    //std::string devTemp = dataFolder + "/devTemperature.vtk";

    std::string meanPressure = dataFolder + "/pressure.vtk";
    //std::string devPressure = dataFolder + "/devPressure.vtk";

    std::string allData = dataFolder + "/";
    ...
    vtkm::cont::ArrayCopyShallowIfPossible(meanWaterFraction.GetField("v02").GetData(), meanWaterFractionArray);
    ...
    vtkm::cont::ArrayCopyShallowIfPossible(meanVorData.GetField("tev").GetData(), meanTempDataArray);
    ...
    vtkm::cont::ArrayCopyShallowIfPossible(meanPressureData.GetField("prs").GetData(), meanPressureDataArray);
    ...
    //vtkm::Vec3f minAxisValue(0.8, 0.3, 30000);
    ...
    dataSetForFilter.AddPointField("ensemble_min_one", meanWaterFractionArray);
    dataSetForFilter.AddPointField("ensemble_max_one", meanWaterFractionArray);

    dataSetForFilter.AddPointField("ensemble_min_two", meanTempDataArray);
    dataSetForFilter.AddPointField("ensemble_max_two", meanTempDataArray);

    dataSetForFilter.AddPointField("ensemble_min_three", meanPressureDataArray);
    dataSetForFilter.AddPointField("ensemble_max_three", meanPressureDataArray);
