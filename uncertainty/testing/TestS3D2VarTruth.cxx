...
#include "../worklet/ExtractingMinMaxFromMeanVarience.hpp"
...
int main(int argc, char *argv[])
{
    ...
    dataSetForFilter.AddPointField("ensemble_min_one", H2_meanArray);
    dataSetForFilter.AddPointField("ensemble_max_one", H2_meanArray);
    ...
    //{        
        ...
        std::string outputFilename = "TestS3D2Var"+Approach+std::to_string(NumSamples)+".vtk"; 
