...
int main(int argc, char *argv[])
{
    ...
    std::string fileName = "/Users/zw1/Downloads/Pf25_5_last2_lrdecay_avg_dev_20.vtk";
    std::string fieldNameAvg = "Average";
    std::string fieldNameStdv = "Standard%20Deviation";
    vtkm::FloatDefault isovalue = -100;
    ...
    std::string outputFileName = "hurrican_ml_output_uni_iso_" + std::to_string(isovalue) + ".vtk";
