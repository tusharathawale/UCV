...
/// that cell.
///
/// This filter uses a uniform distribution model for the uncertainty of a field. To use
/// the field, you must specify a field with the minimum value and one with the maximum
/// value.
///
class ContourUncertainUniform : public vtkm::filter::FilterField
{
...
public:
  ...
  ///@{
  /// Specifies the fields capturing the minimum and maximum values of the data. The field
  /// is assumed to be uniformly distributed between the min and max.
...
#endif //vtk_m_filter_uncertainty_ContourUncertainUniform_h
