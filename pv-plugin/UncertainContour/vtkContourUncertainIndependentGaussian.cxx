#include "vtkContourUncertainIndependentGaussian.h"
...
vtkStandardNewMacro(vtkContourUncertainIndependentGaussian);

vtkContourUncertainIndependentGaussian::vtkContourUncertainIndependentGaussian() = default;
vtkContourUncertainIndependentGaussian::~vtkContourUncertainIndependentGaussian() = default;

std::string vtkContourUncertainIndependentGaussian::GetInputArrayName(
...
void vtkContourUncertainIndependentGaussian::SetInputMean(const char* name)
{
  this->SetInputArrayToProcess(0, 0, 0, vtkDataObject::FIELD_ASSOCIATION_POINTS, name);
}
void vtkContourUncertainIndependentGaussian::SetInputMean(int fieldAttributeType)
{
  this->SetInputArrayToProcess(0, 0, 0, vtkDataObject::FIELD_ASSOCIATION_POINTS, fieldAttributeType);
}
void vtkContourUncertainIndependentGaussian::SetInputStandardDeviation(const char* name)
{
  this->SetInputArrayToProcess(1, 0, 0, vtkDataObject::FIELD_ASSOCIATION_POINTS, name);
}
void vtkContourUncertainIndependentGaussian::SetInputStandardDeviation(int fieldAttributeType)
{
  this->SetInputArrayToProcess(1, 0, 0, vtkDataObject::FIELD_ASSOCIATION_POINTS, fieldAttributeType);
}

int vtkContourUncertainIndependentGaussian::RequestData(
  vtkInformation* request, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  try
  {
    ...
    vtkm::filter::uncertainty::ContourUncertainIndependentGaussian filter;
    ...
    filter.SetStdevField(this->GetInputArrayName(1, inputVector));
...
void vtkContourUncertainIndependentGaussian::PrintSelf(ostream&os, vtkIndent indent)
{
