#include "vtkContourUncertainUniform.h"
...
vtkStandardNewMacro(vtkContourUncertainUniform);

vtkContourUncertainUniform::vtkContourUncertainUniform() = default;
vtkContourUncertainUniform::~vtkContourUncertainUniform() = default;

std::string vtkContourUncertainUniform::GetInputArrayName(
  ...
  vtkInformation* request, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  try
  {
    ...
    filter.SetMinField(this->GetInputArrayName(0, inputVector));
    filter.SetMaxField(this->GetInputArrayName(1, inputVector));
...
void vtkContourUncertainUniform::PrintSelf(ostream&os, vtkIndent indent)
{
