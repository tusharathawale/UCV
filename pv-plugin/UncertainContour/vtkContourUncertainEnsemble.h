 ...
 * and one that captures all the values of the ensemble.
 */

#ifndef vtkContourUncertainEnsemble_h
#define vtkContourUncertainEnsemble_h
...
class VTKUNCERTAINCONTOURFILTERS_EXPORT vtkContourUncertainEnsemble : public vtkImageAlgorithm
{
public:
  vtkTypeMacro(vtkContourUncertainEnsemble, vtkImageAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent) override;
  static vtkContourUncertainEnsemble *New();
...
private:
  vtkContourUncertainEnsemble(const vtkContourUncertainEnsemble&) = delete;
  void operator=(const vtkContourUncertainEnsemble&) = delete;
...
#endif //vtkContourUncertainEnsemble_h
