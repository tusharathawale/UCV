#include "vtkSubsampleUncertaintyIndependentGaussian.h"
...
vtkStandardNewMacro(vtkSubsampleUncertaintyIndependentGaussian);

vtkSubsampleUncertaintyIndependentGaussian::vtkSubsampleUncertaintyIndependentGaussian() = default;
...
int vtkSubsampleUncertaintyIndependentGaussian::RequestInformation(vtkInformation* request,
...
// extent of the input.
int vtkSubsampleUncertaintyIndependentGaussian::RequestUpdateExtent(vtkInformation* request,
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
...
int vtkSubsampleUncertaintyIndependentGaussian::RequestData(
  vtkInformation* request, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  try
  {
    ...
    vtkm::filter::uncertainty::SubsampleUncertaintyIndependentGaussian filter;
    filter.SetMeanSuffix(this->MeanSuffix);
    filter.SetStdevSuffix(this->StdevSuffix);
...
void vtkSubsampleUncertaintyIndependentGaussian::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);

  os << indent << "MeanSuffix: " << this->MeanSuffix << "\n";
  os << indent << "StdevSuffix: " << this->StdevSuffix << "\n";
