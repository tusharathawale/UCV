...
//============================================================================
#ifndef vtk_m_filter_uncertainty_ContourUncertainIndependentGaussian_h
#define vtk_m_filter_uncertainty_ContourUncertainIndependentGaussian_h
...
/// that cell.
///
/// This filter uses an independent Gaussian distribution model for the uncertainty of
/// a field. To use the field, you must specify a field with the mean value and one with
/// the standard deviation.
///
class ContourUncertainIndependentGaussian : public vtkm::filter::FilterField
{
...
public:
  VTKM_CONT ContourUncertainIndependentGaussian();

  ///@{
  /// Specifies the fields capturing the means and standard deviations of the data. The field
  /// is assumed to be distributed as a Gaussian with these parameters.
  VTKM_CONT void SetMeanField(const std::string& fieldName)
  {
    this->SetActiveField(0, fieldName, vtkm::cont::Field::Association::Points);
  }
  VTKM_CONT void SetStdevField(const std::string& fieldName)
  {
...
#endif //vtk_m_filter_uncertainty_ContourUncertainIndependentGaussian_h
